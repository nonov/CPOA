	...
	<body>
		...
		<section>
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
				...
				<div><input type="text" name="job" style="width:180px" placeholder="Job" required = "true"></div>
				<div>
					<select name="pays" style="width:180px"> 
				...
				<div><label> Jury :</label><input type="checkbox" name="jury" style="width:180px" required = "true"></div>
				<div>
					<select name="type_jury" style="width:180px">
